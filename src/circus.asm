...
L_5DBF:
	...
	add a,(hl)			;5dc3
	ld (hl),a			;5dc4
	call pinta_la_figura_grande		;5dc5
	pop af			;5dc8
	ld c,a			;5dc9
	bit 7,a		;5dca
	ld b,000h		;5dcc
...
L_5DEA:
	push af			;5dea
	call cuenta_el_paso		;5deb
	call pinta_el_borde_del_decorado		;5dee
	call desplaza_el_decorado		;5df1
	pop af			;5df4
	or a			;5df5
	ret z			;5df6
L_5DF7:
...
L_6A6D:
	ld h,d			;6a6d
	call posicion_a_celda		;6a6e
	call que_dibujo_toca		;6a71
	ld a,h			;6a74
	ld hl,06aa9h		;6a75
	jr nz,L_6A7D		;6a78
	ld hl,06a9eh		;6a7a
...
L_7A07:
	...
	push bc			;7a0b
	ld d,001h		;7a0c
	call L_7BB8		;7a0e   ; y vuelve a arrancar el mismo sonido
	pop bc			;7a11
	ex af,af'			;7a12
...
L_7AC4:
	...
	ld (ix+004h),h		;7acf
	ex de,hl			;7ad2
	call L_7B8A		;7ad3   ; y se convierte en periodo
	ld a,b			;7ad6
	rrca			;7ad7
	rrca			;7ad8
	rrca			;7ad9
