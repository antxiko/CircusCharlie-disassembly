...
**The game is not ours.** *Circus Charlie* was published by **Konami** for the MSX in 1984;
its catalogue number is **RC-712** and it is 16 KB. All rights over the game
...
The file `src/circus.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Circus Charlie* or hold rights over the game, and you would rather this
